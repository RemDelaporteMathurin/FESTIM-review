...
Tvtu = XMLUnstructuredGridReader(
    registrationName="T.vtu",
    FileName=["T.vtu"],
)
Tvtu.PointArrayStatus = ["Color"]
Tvtu.TimeArray = "None"
...
# show data from Tvtu
TvtuDisplay = Show(Tvtu, renderView1, "UnstructuredGridRepresentation")

# set scalar coloring
ColorBy(TvtuDisplay, ("POINTS", "Color"))

# get min and max of Color
info = Tvtu.GetDataInformation().DataInformation
...
# show color legend
TvtuDisplay.SetScalarBarVisibility(renderView1, True)
