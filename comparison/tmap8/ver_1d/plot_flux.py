...
plt.plot(t_analytic, exact_flux(t_analytic), label="exact solution")
l_festim, = plt.plot(t_festim, flux_festim, label="FESTIM")
l_tmap8, = plt.plot(t_tmap8, flux_tmap8, label="TMAP8")
...
plt.plot(t_festim[idx_festim], flux_festim[idx_festim]/exact_flux(t_festim[idx_festim]), label="FESTIM", color=l_festim.get_color())
plt.plot(t_tmap8[idx_tmap], flux_tmap8[idx_tmap]/exact_flux(t_tmap8[idx_tmap]), label="TMAP8", color=l_tmap8.get_color())
