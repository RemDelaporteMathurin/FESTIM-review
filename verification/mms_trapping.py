...
exact_solution_mobile = 5 + sp.sin(2*sp.pi*(x)) + sp.cos(2*sp.pi*y) # exact solution
exact_solution_trapped = 5 + sp.cos(2*sp.pi*(x)) + sp.sin(2*sp.pi*y) # exact solution
...
my_trap = F.Trap(id=1, k_0=0.1, E_k=0, p_0=0.2, E_p=0, density=density, materials=my_model.materials.materials[0])
...
f_mobile = -div(D*grad(exact_solution_mobile)) + k * exact_solution_mobile * (density - exact_solution_trapped) - p * exact_solution_trapped
f_trap = -k * exact_solution_mobile * (density - exact_solution_trapped) + p * exact_solution_trapped
...
exact_solution_trapped = f.Expression(sp.printing.ccode(exact_solution_trapped), degree=2)
